---
name: pipeline
description: Fährt die komplette Ad-Pipeline in einem Zug, von der Wettbewerber-Ad bis zu fünf gekennzeichneten Clips, und hält nur zweimal an, jeweils vor dem Geldausgeben. Verwenden, wenn der Operator eine Ad reingibt und nicht jeden Schritt einzeln aufrufen will.
---
...
6. `/render` fertig fahren, `/label` anschließen.
7. Übergabe: fünf Clips, Kontaktblätter, ein Satz je Format, welches am ehesten zum Angebot passt. Dann: „Laptop: Schnittprogramm, Musik, Untertitel, Export, Meta als Entwurf."
